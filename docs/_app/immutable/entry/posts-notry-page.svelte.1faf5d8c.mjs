...
`;function C_(i){let r,l,m,d,b,w,v,P,y,T,U,Q,W,L,se,We,Z,$,C,O,D,H,S,k,B,Me,pe,At,It,ee,Ii,Ni,Eo,Nt,Ri,go,Rt,Vi,$o,Vt,qi,Do,qt,Li,xo,He,Si,Nn,Bi,Ui,ko,Lt,Wi,Po,St,Mi,Co,Bt,Hi,Oo,Ut,Yi,To,Wt,ji,Ao,Mt,Qi,Io,Ht,Fi,No,me,Rn,zi,Ji,Vn,Ki,Gi,qn,Xi,Ro,Yt,Zi,Vo,jt,el,qo,Qt,tl,Lo,Ft,nl,So,lt,Bo,F,rl,Ln,ol,sl,Sn,il,ll,Bn,al,fl,Un,cl,ul,Uo,zt,pl,Wo,Ye,ml,Wn,dl,_l,Mo,at,Ho,de,hl,Mn,bl,wl,Hn,yl,vl,Yo,Jt,El,jo,ie,Ce,gl,Yn,$l,Dl,jn,xl,kl,Pl,Qn,Cl,Ol,Fn,Tl,Al,Kt,Il,zn,Nl,Qo,Gt,Rl,Fo,Xt,Vl,zo,z,ql,Jn,Ll,Sl,Kn,Bl,Ul,Gn,Wl,Ml,Xn,Hl,Yl,Jo,ft,Ko,Zt,jl,Go,je,Ql,Zn,Fl,zl,Xo,ct,Zo,ce,er,Jl,Kl,tr,Gl,Xl,nr,Zl,ea,es,ut,ts,te,rr,ta,na,or,ra,oa,sr,sa,ia,ir,la,aa,ns,pt,rs,Qe,fa,lr,ca,ua,os,le,pa,ar,Tu='{ type: "DevError" }',ma,da,fr,Au='getRecord("person", name)',_a,ha,cr,ba,wa,ss,mt,is,_e,ya,ur,Iu='{ type: "UserError", message: "<name> not found" }',va,Ea,pr,ga,$a,ls,dt,as,ue,mr,Da,xa,dr,ka,Pa,_r,Ca,Oa,fs,_t,cs,J,Ta,hr,Aa,Ia,br,Na,Ra,wr,Va,qa,yr,La,Sa,us,ht,ps,en,vr,Ba,ms,Fe,Ua,Er,Wa,Ma,ds,bt,_s,he,Ha,gr,Nu="<Y, N, Args extends unknown[]>",Ya,ja,$r,Qa,Fa,hs,be,za,Dr,Ja,Ka,xr,Ga,Xa,bs,wt,ws,j,Za,kr,ef,tf,Pr,nf,rf,Cr,of,sf,Or,lf,af,Tr,ff,cf,ys,yt,vs,Y,Ar,uf,pf,Ir,mf,df,Nr,_f,hf,Rr,bf,wf,Vr,Ru="{ y: { val: boolean } }",yf,vf,qr,Vu="{ n: { val: Why, exception: unknown } }",Ef,gf,Es,K,$f,Lr,qu="MaybeAsyncDid<Y, N>",Df,xf,Sr,Lu="Did<Y, N>",kf,Pf,Br,Su="Promise<Did<Y, N>>",Cf,Of,Ur,Tf,Af,gs,tn,If,$s,nn,Nf,Ds,vt,xs,G,Rf,Wr,Vf,qf,Mr,Lf,Sf,Hr,Bf,Uf,Yr,Wf,Mf,ks,rn,Hf,Ps,ze,Yf,jr,jf,Qf,Cs,Et,Os,on,Ff,Ts,gt,As,sn,zf,Is,ln,Jf,Ns,Je,Kf,Qr,Gf,Xf,Rs,$t,Vs,we,Zf,Fr,ec,tc,zr,nc,rc,qs,Dt,Ls,an,oc,Ss,fn,sc,Bs,Ke,ic,Jr,lc,ac,Us,xt,Ws,Ge,fc,Kr,cc,uc,Ms,kt,Hs,Xe,pc,Gr,Bu="quit: Quit<Why>",mc,dc,Ys,cn,_c,js,un,hc,Qs,pn,bc,Fs,ae,wc,Xr,yc,vc,Zr,Ec,gc,eo,$c,Dc,zs,X,xc,to,kc,Pc,no,Cc,Oc,ro,Tc,Ac,oo,Ic,Nc,Js,mn,Rc,Ks,ye,Vc,so,qc,Lc,io,Sc,Bc,Gs,Pt,lo,Uc,Wc,Xs,Oe,ao,Mc,Hc,fo,Yc,jc,Zs,dn,Qc,ei,ne,Fc,co,zc,Jc,uo,Kc,Gc,po,Xc,Zc,ti,_n,eu,ni,Te,hn,tu,nu,Ze,ru,ri,Ae,bn,ou,su,et,iu,oi,Ie,wn,lu,au,tt,fu,si,Ne,yn,cu,uu,Re,pu,ii,Ve,vn,mu,du,qe,_u,li,Le,En,hu,bu,Se,wu,ai;return v=new Pe({props:{files:[{name:"person",src:m_},{name:"store",src:An,show:!1}]}}),$=new Pe({props:{files:[{name:"vote",src:d_},{name:"person",src:Td},{name:"store",src:An,show:!1}]}}),S=new Pe({props:{files:[{name:"main",src:__},{name:"vote",src:P_},{name:"person",src:Td},{name:"store",src:An,show:!1}]}}),lt=new Pe({props:{files:[{name:"main",src:h_},{name:"vote-try-catch",src:k_},{name:"person-try-catch",src:E_},{name:"error",src:Cd},{name:"report",src:gu,show:!1},{name:"store",src:An,show:!1}]}}),at=new Pe({props:{files:[{name:"main",src:b_},{name:"vote-return",src:x_},{name:"person-return",src:v_},{name:"error",src:Cd},{name:"report",src:gu,show:!1},{name:"store",src:An,show:!1}]}}),ft=new Pe({props:{files:[{name:"main",src:w_},{name:"vote-notry",src:D_},{name:"person-notry",src:y_},{name:"report",src:gu,show:!1},{name:"store",src:An,show:!1},{name:"notry-ts",src:Od,show:!1}]}}),ct=new ke({props:{value:i[1]}}),ut=new ke({props:{value:i[2]}}),pt=new ke({props:{value:i[3]}}),mt=new ke({props:{value:i[4]}}),dt=new ke({props:{value:A_}}),_t=new ke({props:{value:i[5]}}),ht=new ke({props:{value:i[6]}}),bt=new ke({props:{value:i[7]}}),wt=new ke({props:{value:i[8]}}),yt=new ke({props:{value:i[9]}}),vt=new Pe({props:{files:[{name:"main",src:Ci},{name:"ext",src:Pi,show:!1}]}}),Et=new Pe({props:{files:[{name:"main",src:Nd},{name:"safe-try-catch",src:$_},{name:"ext",src:Pi,show:!1}]}}),gt=new Eu({props:{original:Ci,modified:Nd}}),$t=new Pe({props:{files:[{name:"main",src:Id},{name:"safe-return",src:g_},{name:"ext",src:Pi,show:!1}]}}),Dt=new Eu({props:{original:Ci,modified:Id}}),xt=new Pe({props:{files:[{name:"main",src:Ad},{name:"ext",src:Pi,show:!1},{name:"notry-ts",src:Od,show:!1}]}}),kt=new Eu({props:{original:Ci,modified:Ad}}),{c(){r=f("p"),l=o(`Suppose you're asked to write a new function to determine whether a person\r
    can vote. It should be easy since there's already a `),m=f("code"),d=o("getPerson"),b=o(" function."),w=_(),A(v.$$.fragment),P=_(),y=f("p"),T=o("Notice that the function signature gives no hint that "),U=f("code"),Q=o("getPerson"),W=o(`\r
    could throw. This is one problem we want to address.`),L=_(),se=f("p"),We=o("Here's the new function."),Z=_(),A($.$$.fragment),C=_(),O=f("p"),D=o("And last but not least, the main progam."),H=_(),A(S.$$.fragment),k=_(),B=f("p"),Me=o("Note here that the type of "),pe=f("code"),At=o("exceptionVar"),It=o(` is\r
    `),ee=f("code"),Ii=o("unknown"),Ni=o(`. If you make it something more specific you'll get a\r
    compiler error.`),Eo=_(),Nt=f("pre"),Ri=o("Catch clause variable type annotation must be 'any' or 'unknown' if specified."),go=_(),Rt=f("p"),Vi=o("This is another problem we'll try to tackle."),$o=_(),Vt=f("h4"),qi=o("Test Cases"),Do=_(),qt=f("p"),Li=o(`If you run the previous example, you should see three lines written to the\r
    console.`),xo=_(),He=f("p"),Si=o("The first shows the output of a successful invocation of "),Nn=f("code"),Bi=o("main"),Ui=o("."),ko=_(),Lt=f("pre"),Wi=o("Neil can't vote"),Po=_(),St=f("p"),Mi=o("The second invocation failed with what is probably a user error."),Co=_(),Bt=f("pre"),Hi=o("Error: Neal not found"),Oo=_(),Ut=f("p"),Yi=o(`The final result is another error but this time the meaning is less clear.\r
    It could be an environmental or maybe a programming error. In either case,\r
    it's not something we expect the user to be able to handle.`),To=_(),Wt=f("pre"),ji=o("Error: Failed to get record"),Ao=_(),Mt=f("p"),Qi=o(`Unfortunately, this isn't terribly helpful. It means nothing to the user and\r
    doesn't give the developer much to debug with.`),Io=_(),Ht=f("p"),Fi=o("So how could we improve? A few ideas:"),No=_(),me=f("ol"),Rn=f("li"),zi=o(`Log the error stack trace: this would be helpful to the developer, but\r
      probably scare the user.`),Ji=_(),Vn=f("li"),Ki=o(`Report the stack trace to the developer. On user errors, this would\r
      produce noise for the developer. On developer errors, the message would\r
      still be confusing to the user.`),Gi=_(),qn=f("li"),Xi=o("Find a mechanism for differentiating error types."),Ro=_(),Yt=f("h3"),Zi=o("Approaches"),Vo=_(),jt=f("p"),el=o(`Let's explore idea #3 and compare error handling approaches using the three\r
    test cases.`),qo=_(),Qt=f("h4"),tl=o("try-catch"),Lo=_(),Ft=f("p"),nl=o("One simple solution is to throw subclassed Error objects."),So=_(),A(lt.$$.fragment),Bo=_(),F=f("p"),rl=o(`That's better but the type checker doesn't help much. Without reading the\r
    ...
    something different, the compiler won't tell us.`),Uo=_(),zt=f("h4"),pl=o("Return Types"),Wo=_(),Ye=f("p"),ml=o(`One way to lean on the type system for error handling is by using a\r
    specialized return type. We'll use a union of the successful return type and\r
    `),Wn=f("code"),dl=o("Error"),_l=o("s to keep things simple."),Mo=_(),A(at.$$.fragment),Ho=_(),de=f("p"),hl=o("This yields the same result as "),Mn=f("b"),bl=o("try-catch"),wl=o(` with the added benefit of\r
    type safety. The biggest downside is the extra check in `),Hn=f("code"),yl=o("canVote"),vl=o(`\r
    (more on that later).`),Yo=_(),Jt=f("p"),El=o("Following this approach boils down to:"),jo=_(),ie=f("ol"),Ce=f("li"),gl=o("Replacing "),Yn=f("code"),$l=o("throw"),Dl=o(" with "),jn=f("code"),xl=o("return"),kl=o(" in your code"),Pl=_(),Qn=f("li"),Cl=o("Updating the return types"),Ol=_(),Fn=f("li"),Tl=o("Propagating errors up the call stack"),Al=_(),Kt=f("li"),Il=o("Wrapping invocations of code you don't control in "),zn=f("code"),Nl=o("try-catch"),Qo=_(),Gt=f("p"),Rl=o(`There are some simple utilities you can write to make this easier. Still,\r
    one can't help but wonder - is there a better way?`),Fo=_(),Xt=f("h4"),Vl=o("notry-ts"),zo=_(),z=f("p"),ql=o("What if we could get the convenience of "),Jn=f("b"),Ll=o("try-catch"),Sl=o(` and the type safety\r
    of `),Kn=f("b"),Bl=o("return types"),Ul=o(`? That's what I set out to answer when I created\r
    `),Gn=f("b"),Wl=o("notry-ts"),Ml=o(". Let's see how our example looks with "),Xn=f("code"),Hl=o("notry"),Yl=o("."),Jo=_(),A(ft.$$.fragment),Ko=_(),Zt=f("p"),jl=o(`This produces the same output as the two previous solutions, so how does it\r
    work?`),Go=_(),je=f("p"),Ql=o("The first thing you'll notice is the new "),Zn=f("code"),Fl=o("Why"),zl=o(" type."),Xo=_(),A(ct.$$.fragment),Zo=_(),ce=f("p"),er=f("code"),Jl=o("Why"),Kl=o(" represents the type returned when "),tr=f("code"),Gl=o("getPerson"),Xl=o(`\r
    fails. It's used in the new first parameter of `),nr=f("code"),Zl=o("getPerson"),ea=o("."),es=_(),A(ut.$$.fragment),ts=_(),te=f("p"),rr=f("code"),ta=o("quit"),na=o(` has the call signature\r
    ...
    by calling:`),ns=_(),A(pt.$$.fragment),rs=_(),Qe=f("p"),fa=o("Rather than call "),lr=f("code"),ca=o("quit"),ua=o(" directly, we use two convenience functions."),os=_(),le=f("p"),pa=o(`This quits with\r
    `),ar=f("code"),ma=o(Tu),da=o(` if\r
    `),fr=f("code"),_a=o(Au),ha=o(`\r
    throws, returning a `),cr=f("code"),ba=o("Person"),wa=o(" otherwise."),ss=_(),A(mt.$$.fragment),is=_(),_e=f("p"),ya=o(`This quits with\r
    `),ur=f("code"),va=o(Iu),Ea=o(`\r
    if `),pr=f("code"),ga=o("person"),$a=o(" is undefined."),ls=_(),A(dt.$$.fragment),as=_(),ue=f("p"),mr=f("code"),Da=o("canVote"),xa=o(" is straightforward. It takes a "),dr=f("code"),ka=o("quit"),Pa=o(`\r
    parameter of the same type as `),_r=f("code"),Ca=o("getPerson"),Oa=o(" and forwards it."),fs=_(),A(_t.$$.fragment),cs=_(),J=f("p"),Ta=o("At the top level, "),hr=f("code"),Aa=o("main"),Ia=o(" invokes "),br=f("code"),Na=o("canVote"),Ra=o(` with\r
    `),wr=f("code"),Va=o("notry"),qa=o(" and assigns the result to "),yr=f("code"),La=o("did"),Sa=o("."),us=_(),A(ht.$$.fragment),ps=_(),en=f("p"),vr=f("b"),Ba=o("How it works"),ms=_(),Fe=f("p"),Ua=o("Here is the function signature of "),Er=f("code"),Wa=o("notry"),Ma=o("."),ds=_(),A(bt.$$.fragment),_s=_(),he=f("p"),Ha=o("The generic types "),gr=f("code"),Ya=o(Nu),ja=o(` represent\r
    the successful return type, failed return type, and `),$r=f("code"),Qa=o("quitable"),Fa=o(" arguments."),hs=_(),be=f("p"),za=o("Any function that accepts "),Dr=f("code"),Ja=o("Quit"),Ka=o(` as it's first parameter is a\r
    `),xr=f("code"),Ga=o("Quitable"),Xa=o("."),bs=_(),A(wt.$$.fragment),ws=_(),j=f("p"),Za=o("So "),kr=f("code"),ef=o("notry"),tf=o(" requires a "),Pr=f("code"),nf=o("Quitable"),rf=o(` function and\r
    arguments to pass it and returns a `),Cr=f("code"),of=o("Did"),sf=o(` containing the result\r
    (either `),Or=f("code"),lf=o("Y"),af=o(" or "),Tr=f("code"),ff=o("N"),cf=o(")."),ys=_(),A(yt.$$.fragment),vs=_(),Y=f("p"),Ar=f("code"),uf=o("Did"),pf=o(" is a riff on the popular "),Ir=f("code"),mf=o("Either"),df=o(` or\r
    ...
    `),Vr=f("code"),yf=o(Ru),vf=o(` or\r
    `),qr=f("code"),Ef=o(Vu),gf=o("."),Es=_(),K=f("p"),$f=o("The last piece of the puzzle is "),Lr=f("code"),Df=o(qu),xf=o(`. It\r
    resolves to `),Sr=f("code"),kf=o(Lu),Pf=o(` or\r
    `),Br=f("code"),Cf=o(Su),Of=o(`\r
    depending on whether `),Ur=f("code"),Tf=o("quitable"),Af=o(" returns a promise."),gs=_(),tn=f("h3"),If=o("Error Handling At Scale"),$s=_(),nn=f("p"),Nf=o(`In the preceding problem, the difference in error handling solutions might\r
    seem insignificant. Here we'll look at a fleshier example and try to\r
    understand how each approach scales.`),Ds=_(),A(vt.$$.fragment),xs=_(),G=f("p"),Rf=o("The three external functions "),Wr=f("code"),Vf=o("c"),qf=o(", "),Mr=f("code"),Lf=o("d"),Sf=o(`, and\r
    `),Hr=f("code"),Bf=o("e"),Uf=o(`\r
    could throw so `),Yr=f("code"),Wf=o("main"),Mf=o(` catches and logs the exception. In the base\r
    case there is no way to differentiate the three possible failures.`),ks=_(),rn=f("h4"),Hf=o("try-catch"),Ps=_(),ze=f("p"),Yf=o("Let's introduce a utility "),jr=f("code"),jf=o("safe"),Qf=o(` to catch arbitrary exceptions and\r
    throw something specific.`),Cs=_(),A(Et.$$.fragment),Os=_(),on=f("p"),Ff=o("The diff shows that it's an unobtrusive change."),Ts=_(),A(gt.$$.fragment),As=_(),sn=f("p"),zf=o("However, no type safety."),Is=_(),ln=f("h4"),Jf=o("Return types"),Ns=_(),Je=f("p"),Kf=o("This time we use a variant of "),Qr=f("code"),Gf=o("safe"),Xf=o(` that catch exceptions and returns\r
    something specific.`),Rs=_(),A($t.$$.fragment),Vs=_(),we=f("p"),Zf=o("Unfortunately now three of the five lines in both "),Fr=f("code"),ec=o("a"),tc=o(` and\r
    `),zr=f("code"),nc=o("b"),rc=o(` are error handling. It's easy to see how this can get unwieldy\r
    at scale.`),qs=_(),A(Dt.$$.fragment),Ls=_(),an=f("p"),oc=o("But now we have type safety."),Ss=_(),fn=f("h4"),sc=o("notry-ts"),Bs=_(),Ke=f("p"),ic=o("Finally, an implementation using "),Jr=f("code"),lc=o("notry"),ac=o("."),Us=_(),A(xt.$$.fragment),Ws=_(),Ge=f("p"),fc=o("Apart from the "),Kr=f("code"),cc=o("quit"),uc=o(` parameters, this looks more or less like the\r
    base case.`),Ms=_(),A(kt.$$.fragment),Hs=_(),Xe=f("p"),pc=o("Admittedly, all those "),Gr=f("code"),mc=o(Bu),dc=o(` parameters are a bit cumbersome\r
    so, like anything, you should weigh the benefits against the costs.`),Ys=_(),cn=f("h3"),_c=o("Comparison"),js=_(),un=f("p"),hc=o("Let's wrap up by looking at what we get from each approach."),Qs=_(),pn=f("h4"),bc=o("Type Safety"),Fs=_(),ae=f("p"),wc=o("None with "),Xr=f("b"),yc=o("try-catch"),vc=o(` and roughly the same degree with\r
    `),Zr=f("b"),Ec=o("return types"),gc=o(" and "),eo=f("b"),$c=o("notry-ts"),Dc=o(` including the ability to tell at a glance\r
    if and what errors could occur.`),zs=_(),X=f("p"),xc=o("The biggest difference is that it's easier to ignore "),to=f("b"),kc=o("return types"),Pc=o(`. If\r
    ...
    `),ro=f("b"),Tc=o("notry-ts"),Ac=o(" where "),oo=f("code"),Ic=o("notry"),Nc=o(" is called."),Js=_(),mn=f("h4"),Rc=o("Developer Experience"),Ks=_(),ye=f("p"),Vc=o("With "),so=f("b"),qc=o("try-catch"),Lc=o(", you could use a utility like "),io=f("code"),Sc=o("safe"),Bc=o(` to incrementally\r
    improve your error handling done with minimal effect on readability.`),Gs=_(),Pt=f("p"),lo=f("b"),Uc=o("return types"),Wc=o(` are intuitive since it's natural to associate a function's\r
    return value with its outcome. This solution requires the greatest amount of\r
    code and gains usefulness the more it's used.`),Xs=_(),Oe=f("p"),ao=f("b"),Mc=o("notry"),Hc=o(` has the least intuitive and most sophisticated typing. The\r
    function body's intent remains clear with error handling is mostly out of\r
    view. As with\r
    `),fo=f("b"),Yc=o("return types"),jc=o(", its usefulness is dependent on how widely it's used."),Zs=_(),dn=f("h3"),Qc=o("Conclusion"),ei=_(),ne=f("p"),Fc=o(`If you care about type safety (why else would you be here), use\r
    ...
    can vote. It should be easy since there's already a `),m=c(a,"CODE",{});var Uu=u(m);d=s(Uu,"getPerson"),Uu.forEach(t),b=s(a," function."),a.forEach(t),w=h(e),I(v.$$.fragment,e),P=h(e),y=c(e,"P",{});var fi=u(y);T=s(fi,"Notice that the function signature gives no hint that "),U=c(fi,"CODE",{});var Wu=u(U);Q=s(Wu,"getPerson"),Wu.forEach(t),W=s(fi,`\r
    could throw. This is one problem we want to address.`),fi.forEach(t),L=h(e),se=c(e,"P",{});var Mu=u(se);We=s(Mu,"Here's the new function."),Mu.forEach(t),Z=h(e),I($.$$.fragment,e),C=h(e),O=c(e,"P",{});var Hu=u(O);D=s(Hu,"And last but not least, the main progam."),Hu.forEach(t),H=h(e),I(S.$$.fragment,e),k=h(e),B=c(e,"P",{});var gn=u(B);Me=s(gn,"Note here that the type of "),pe=c(gn,"CODE",{});var Yu=u(pe);At=s(Yu,"exceptionVar"),Yu.forEach(t),It=s(gn,` is\r
    `),ee=c(gn,"CODE",{});var ju=u(ee);Ii=s(ju,"unknown"),ju.forEach(t),Ni=s(gn,`. If you make it something more specific you'll get a\r
    compiler error.`),gn.forEach(t),Eo=h(e),Nt=c(e,"PRE",{});var Qu=u(Nt);Ri=s(Qu,"Catch clause variable type annotation must be 'any' or 'unknown' if specified."),Qu.forEach(t),go=h(e),Rt=c(e,"P",{});var Fu=u(Rt);Vi=s(Fu,"This is another problem we'll try to tackle."),Fu.forEach(t),$o=h(e),Vt=c(e,"H4",{});var zu=u(Vt);qi=s(zu,"Test Cases"),zu.forEach(t),Do=h(e),qt=c(e,"P",{});var Ju=u(qt);Li=s(Ju,`If you run the previous example, you should see three lines written to the\r
    console.`),Ju.forEach(t),xo=h(e),He=c(e,"P",{});var ci=u(He);Si=s(ci,"The first shows the output of a successful invocation of "),Nn=c(ci,"CODE",{});var Ku=u(Nn);Bi=s(Ku,"main"),Ku.forEach(t),Ui=s(ci,"."),ci.forEach(t),ko=h(e),Lt=c(e,"PRE",{});var Gu=u(Lt);Wi=s(Gu,"Neil can't vote"),Gu.forEach(t),Po=h(e),St=c(e,"P",{});var Xu=u(St);Mi=s(Xu,"The second invocation failed with what is probably a user error."),Xu.forEach(t),Co=h(e),Bt=c(e,"PRE",{});var Zu=u(Bt);Hi=s(Zu,"Error: Neal not found"),Zu.forEach(t),Oo=h(e),Ut=c(e,"P",{});var ep=u(Ut);Yi=s(ep,`The final result is another error but this time the meaning is less clear.\r
    It could be an environmental or maybe a programming error. In either case,\r
    it's not something we expect the user to be able to handle.`),ep.forEach(t),To=h(e),Wt=c(e,"PRE",{});var tp=u(Wt);ji=s(tp,"Error: Failed to get record"),tp.forEach(t),Ao=h(e),Mt=c(e,"P",{});var np=u(Mt);Qi=s(np,`Unfortunately, this isn't terribly helpful. It means nothing to the user and\r
    doesn't give the developer much to debug with.`),np.forEach(t),Io=h(e),Ht=c(e,"P",{});var rp=u(Ht);Fi=s(rp,"So how could we improve? A few ideas:"),rp.forEach(t),No=h(e),me=c(e,"OL",{});var $n=u(me);Rn=c($n,"LI",{});var op=u(Rn);zi=s(op,`Log the error stack trace: this would be helpful to the developer, but\r
      probably scare the user.`),op.forEach(t),Ji=h($n),Vn=c($n,"LI",{});var sp=u(Vn);Ki=s(sp,`Report the stack trace to the developer. On user errors, this would\r
      produce noise for the developer. On developer errors, the message would\r
      still be confusing to the user.`),sp.forEach(t),Gi=h($n),qn=c($n,"LI",{});var ip=u(qn);Xi=s(ip,"Find a mechanism for differentiating error types."),ip.forEach(t),$n.forEach(t),Ro=h(e),Yt=c(e,"H3",{});var lp=u(Yt);Zi=s(lp,"Approaches"),lp.forEach(t),Vo=h(e),jt=c(e,"P",{});var ap=u(jt);el=s(ap,`Let's explore idea #3 and compare error handling approaches using the three\r
    ...
    `),Ln=c(ve,"CODE",{});var up=u(Ln);ol=s(up,"getPerson"),up.forEach(t),sl=s(ve,` source, we can't tell what (or even if) it could\r
    throw. `),Sn=c(ve,"CODE",{});var pp=u(Sn);il=s(pp,"exceptionVar"),pp.forEach(t),ll=s(ve," still has type "),Bn=c(ve,"CODE",{});var mp=u(Bn);al=s(mp,"unknown"),mp.forEach(t),fl=s(ve,`.\r
    Narrowing it takes extra effort and if `),Un=c(ve,"CODE",{});var dp=u(Un);cl=s(dp,"getPerson"),dp.forEach(t),ul=s(ve,` starts throwing\r
    something different, the compiler won't tell us.`),ve.forEach(t),Uo=h(e),zt=c(e,"H4",{});var _p=u(zt);pl=s(_p,"Return Types"),_p.forEach(t),Wo=h(e),Ye=c(e,"P",{});var ui=u(Ye);ml=s(ui,`One way to lean on the type system for error handling is by using a\r
    specialized return type. We'll use a union of the successful return type and\r
    `),Wn=c(ui,"CODE",{});var hp=u(Wn);dl=s(hp,"Error"),hp.forEach(t),_l=s(ui,"s to keep things simple."),ui.forEach(t),Mo=h(e),I(at.$$.fragment,e),Ho=h(e),de=c(e,"P",{});var Dn=u(de);hl=s(Dn,"This yields the same result as "),Mn=c(Dn,"B",{});var bp=u(Mn);bl=s(bp,"try-catch"),bp.forEach(t),wl=s(Dn,` with the added benefit of\r
    type safety. The biggest downside is the extra check in `),Hn=c(Dn,"CODE",{});var wp=u(Hn);yl=s(wp,"canVote"),wp.forEach(t),vl=s(Dn,`\r
    (more on that later).`),Dn.forEach(t),Yo=h(e),Jt=c(e,"P",{});var yp=u(Jt);El=s(yp,"Following this approach boils down to:"),yp.forEach(t),jo=h(e),ie=c(e,"OL",{});var nt=u(ie);Ce=c(nt,"LI",{});var xn=u(Ce);gl=s(xn,"Replacing "),Yn=c(xn,"CODE",{});var vp=u(Yn);$l=s(vp,"throw"),vp.forEach(t),Dl=s(xn," with "),jn=c(xn,"CODE",{});var Ep=u(jn);xl=s(Ep,"return"),Ep.forEach(t),kl=s(xn," in your code"),xn.forEach(t),Pl=h(nt),Qn=c(nt,"LI",{});var gp=u(Qn);Cl=s(gp,"Updating the return types"),gp.forEach(t),Ol=h(nt),Fn=c(nt,"LI",{});var $p=u(Fn);Tl=s($p,"Propagating errors up the call stack"),$p.forEach(t),Al=h(nt),Kt=c(nt,"LI",{});var yu=u(Kt);Il=s(yu,"Wrapping invocations of code you don't control in "),zn=c(yu,"CODE",{});var Dp=u(zn);Nl=s(Dp,"try-catch"),Dp.forEach(t),yu.forEach(t),nt.forEach(t),Qo=h(e),Gt=c(e,"P",{});var xp=u(Gt);Rl=s(xp,`There are some simple utilities you can write to make this easier. Still,\r
    one can't help but wonder - is there a better way?`),xp.forEach(t),Fo=h(e),Xt=c(e,"H4",{});var kp=u(Xt);Vl=s(kp,"notry-ts"),kp.forEach(t),zo=h(e),z=c(e,"P",{});var Ee=u(z);ql=s(Ee,"What if we could get the convenience of "),Jn=c(Ee,"B",{});var Pp=u(Jn);Ll=s(Pp,"try-catch"),Pp.forEach(t),Sl=s(Ee,` and the type safety\r
    of `),Kn=c(Ee,"B",{});var Cp=u(Kn);Bl=s(Cp,"return types"),Cp.forEach(t),Ul=s(Ee,`? That's what I set out to answer when I created\r
    `),Gn=c(Ee,"B",{});var Op=u(Gn);Wl=s(Op,"notry-ts"),Op.forEach(t),Ml=s(Ee,". Let's see how our example looks with "),Xn=c(Ee,"CODE",{});var Tp=u(Xn);Hl=s(Tp,"notry"),Tp.forEach(t),Yl=s(Ee,"."),Ee.forEach(t),Jo=h(e),I(ft.$$.fragment,e),Ko=h(e),Zt=c(e,"P",{});var Ap=u(Zt);jl=s(Ap,`This produces the same output as the two previous solutions, so how does it\r
    work?`),Ap.forEach(t),Go=h(e),je=c(e,"P",{});var pi=u(je);Ql=s(pi,"The first thing you'll notice is the new "),Zn=c(pi,"CODE",{});var Ip=u(Zn);Fl=s(Ip,"Why"),Ip.forEach(t),zl=s(pi," type."),pi.forEach(t),Xo=h(e),I(ct.$$.fragment,e),Zo=h(e),ce=c(e,"P",{});var Ct=u(ce);er=c(Ct,"CODE",{});var Np=u(er);Jl=s(Np,"Why"),Np.forEach(t),Kl=s(Ct," represents the type returned when "),tr=c(Ct,"CODE",{});var Rp=u(tr);Gl=s(Rp,"getPerson"),Rp.forEach(t),Xl=s(Ct,`\r
    fails. It's used in the new first parameter of `),nr=c(Ct,"CODE",{});var Vp=u(nr);Zl=s(Vp,"getPerson"),Vp.forEach(t),ea=s(Ct,"."),Ct.forEach(t),es=h(e),I(ut.$$.fragment,e),ts=h(e),te=c(e,"P",{});var Be=u(te);rr=c(Be,"CODE",{});var qp=u(rr);ta=s(qp,"quit"),qp.forEach(t),na=s(Be,` has the call signature\r
    `),or=c(Be,"CODE",{});var Lp=u(or);ra=s(Lp,"(val: Why) => never"),Lp.forEach(t),oa=s(Be,`. Calling it immediately terminates\r
    `),sr=c(Be,"CODE",{});var Sp=u(sr);sa=s(Sp,"getPerson"),Sp.forEach(t),ia=s(Be,`. So in this case, we could terminate\r
    `),ir=c(Be,"CODE",{});var Bp=u(ir);la=s(Bp,"getPerson"),Bp.forEach(t),aa=s(Be,`\r
    by calling:`),Be.forEach(t),ns=h(e),I(pt.$$.fragment,e),rs=h(e),Qe=c(e,"P",{});var mi=u(Qe);fa=s(mi,"Rather than call "),lr=c(mi,"CODE",{});var Up=u(lr);ca=s(Up,"quit"),Up.forEach(t),ua=s(mi," directly, we use two convenience functions."),mi.forEach(t),os=h(e),le=c(e,"P",{});var rt=u(le);pa=s(rt,`This quits with\r
    `),ar=c(rt,"CODE",{});var Wp=u(ar);ma=s(Wp,Tu),Wp.forEach(t),da=s(rt,` if\r
    `),fr=c(rt,"CODE",{});var Mp=u(fr);_a=s(Mp,Au),Mp.forEach(t),ha=s(rt,`\r
    throws, returning a `),cr=c(rt,"CODE",{});var Hp=u(cr);ba=s(Hp,"Person"),Hp.forEach(t),wa=s(rt," otherwise."),rt.forEach(t),ss=h(e),I(mt.$$.fragment,e),is=h(e),_e=c(e,"P",{});var kn=u(_e);ya=s(kn,`This quits with\r
    `),ur=c(kn,"CODE",{});var Yp=u(ur);va=s(Yp,Iu),Yp.forEach(t),Ea=s(kn,`\r
    if `),pr=c(kn,"CODE",{});var jp=u(pr);ga=s(jp,"person"),jp.forEach(t),$a=s(kn," is undefined."),kn.forEach(t),ls=h(e),I(dt.$$.fragment,e),as=h(e),ue=c(e,"P",{});var Ot=u(ue);mr=c(Ot,"CODE",{});var Qp=u(mr);Da=s(Qp,"canVote"),Qp.forEach(t),xa=s(Ot," is straightforward. It takes a "),dr=c(Ot,"CODE",{});var Fp=u(dr);ka=s(Fp,"quit"),Fp.forEach(t),Pa=s(Ot,`\r
    ...
    `),wr=c(ge,"CODE",{});var Gp=u(wr);Va=s(Gp,"notry"),Gp.forEach(t),qa=s(ge," and assigns the result to "),yr=c(ge,"CODE",{});var Xp=u(yr);La=s(Xp,"did"),Xp.forEach(t),Sa=s(ge,"."),ge.forEach(t),us=h(e),I(ht.$$.fragment,e),ps=h(e),en=c(e,"P",{});var Zp=u(en);vr=c(Zp,"B",{});var em=u(vr);Ba=s(em,"How it works"),em.forEach(t),Zp.forEach(t),ms=h(e),Fe=c(e,"P",{});var di=u(Fe);Ua=s(di,"Here is the function signature of "),Er=c(di,"CODE",{});var tm=u(Er);Wa=s(tm,"notry"),tm.forEach(t),Ma=s(di,"."),di.forEach(t),ds=h(e),I(bt.$$.fragment,e),_s=h(e),he=c(e,"P",{});var Pn=u(he);Ha=s(Pn,"The generic types "),gr=c(Pn,"CODE",{});var nm=u(gr);Ya=s(nm,Nu),nm.forEach(t),ja=s(Pn,` represent\r
    the successful return type, failed return type, and `),$r=c(Pn,"CODE",{});var rm=u($r);Qa=s(rm,"quitable"),rm.forEach(t),Fa=s(Pn," arguments."),Pn.forEach(t),hs=h(e),be=c(e,"P",{});var Cn=u(be);za=s(Cn,"Any function that accepts "),Dr=c(Cn,"CODE",{});var om=u(Dr);Ja=s(om,"Quit"),om.forEach(t),Ka=s(Cn,` as it's first parameter is a\r
    `),xr=c(Cn,"CODE",{});var sm=u(xr);Ga=s(sm,"Quitable"),sm.forEach(t),Xa=s(Cn,"."),Cn.forEach(t),bs=h(e),I(wt.$$.fragment,e),ws=h(e),j=c(e,"P",{});var fe=u(j);Za=s(fe,"So "),kr=c(fe,"CODE",{});var im=u(kr);ef=s(im,"notry"),im.forEach(t),tf=s(fe," requires a "),Pr=c(fe,"CODE",{});var lm=u(Pr);nf=s(lm,"Quitable"),lm.forEach(t),rf=s(fe,` function and\r
    arguments to pass it and returns a `),Cr=c(fe,"CODE",{});var am=u(Cr);of=s(am,"Did"),am.forEach(t),sf=s(fe,` containing the result\r
    (either `),Or=c(fe,"CODE",{});var fm=u(Or);lf=s(fm,"Y"),fm.forEach(t),af=s(fe," or "),Tr=c(fe,"CODE",{});var cm=u(Tr);ff=s(cm,"N"),cm.forEach(t),cf=s(fe,")."),fe.forEach(t),ys=h(e),I(yt.$$.fragment,e),vs=h(e),Y=c(e,"P",{});var re=u(Y);Ar=c(re,"CODE",{});var um=u(Ar);uf=s(um,"Did"),um.forEach(t),pf=s(re," is a riff on the popular "),Ir=c(re,"CODE",{});var pm=u(Ir);mf=s(pm,"Either"),pm.forEach(t),df=s(re,` or\r
    `),Nr=c(re,"CODE",{});var mm=u(Nr);_f=s(mm,"Result"),mm.forEach(t),hf=s(re,`\r
    types. It's a discriminated union that indicates whether\r
    `),Rr=c(re,"CODE",{});var dm=u(Rr);bf=s(dm,"quitable"),dm.forEach(t),wf=s(re,` returned or quit. In this case, it'll be\r
    `),Vr=c(re,"CODE",{});var _m=u(Vr);yf=s(_m,Ru),_m.forEach(t),vf=s(re,` or\r
    `),qr=c(re,"CODE",{});var hm=u(qr);Ef=s(hm,Vu),hm.forEach(t),gf=s(re,"."),re.forEach(t),Es=h(e),K=c(e,"P",{});var $e=u(K);$f=s($e,"The last piece of the puzzle is "),Lr=c($e,"CODE",{});var bm=u(Lr);Df=s(bm,qu),bm.forEach(t),xf=s($e,`. It\r
    resolves to `),Sr=c($e,"CODE",{});var wm=u(Sr);kf=s(wm,Lu),wm.forEach(t),Pf=s($e,` or\r
    `),Br=c($e,"CODE",{});var ym=u(Br);Cf=s(ym,Su),ym.forEach(t),Of=s($e,`\r
    depending on whether `),Ur=c($e,"CODE",{});var vm=u(Ur);Tf=s(vm,"quitable"),vm.forEach(t),Af=s($e," returns a promise."),$e.forEach(t),gs=h(e),tn=c(e,"H3",{});var Em=u(tn);If=s(Em,"Error Handling At Scale"),Em.forEach(t),$s=h(e),nn=c(e,"P",{});var gm=u(nn);Nf=s(gm,`In the preceding problem, the difference in error handling solutions might\r
    seem insignificant. Here we'll look at a fleshier example and try to\r
    understand how each approach scales.`),gm.forEach(t),Ds=h(e),I(vt.$$.fragment,e),xs=h(e),G=c(e,"P",{});var De=u(G);Rf=s(De,"The three external functions "),Wr=c(De,"CODE",{});var $m=u(Wr);Vf=s($m,"c"),$m.forEach(t),qf=s(De,", "),Mr=c(De,"CODE",{});var Dm=u(Mr);Lf=s(Dm,"d"),Dm.forEach(t),Sf=s(De,`, and\r
    `),Hr=c(De,"CODE",{});var xm=u(Hr);Bf=s(xm,"e"),xm.forEach(t),Uf=s(De,`\r
    could throw so `),Yr=c(De,"CODE",{});var km=u(Yr);Wf=s(km,"main"),km.forEach(t),Mf=s(De,` catches and logs the exception. In the base\r
    case there is no way to differentiate the three possible failures.`),De.forEach(t),ks=h(e),rn=c(e,"H4",{});var Pm=u(rn);Hf=s(Pm,"try-catch"),Pm.forEach(t),Ps=h(e),ze=c(e,"P",{});var _i=u(ze);Yf=s(_i,"Let's introduce a utility "),jr=c(_i,"CODE",{});var Cm=u(jr);jf=s(Cm,"safe"),Cm.forEach(t),Qf=s(_i,` to catch arbitrary exceptions and\r
    throw something specific.`),_i.forEach(t),Cs=h(e),I(Et.$$.fragment,e),Os=h(e),on=c(e,"P",{});var Om=u(on);Ff=s(Om,"The diff shows that it's an unobtrusive change."),Om.forEach(t),Ts=h(e),I(gt.$$.fragment,e),As=h(e),sn=c(e,"P",{});var Tm=u(sn);zf=s(Tm,"However, no type safety."),Tm.forEach(t),Is=h(e),ln=c(e,"H4",{});var Am=u(ln);Jf=s(Am,"Return types"),Am.forEach(t),Ns=h(e),Je=c(e,"P",{});var hi=u(Je);Kf=s(hi,"This time we use a variant of "),Qr=c(hi,"CODE",{});var Im=u(Qr);Gf=s(Im,"safe"),Im.forEach(t),Xf=s(hi,` that catch exceptions and returns\r
    something specific.`),hi.forEach(t),Rs=h(e),I($t.$$.fragment,e),Vs=h(e),we=c(e,"P",{});var On=u(we);Zf=s(On,"Unfortunately now three of the five lines in both "),Fr=c(On,"CODE",{});var Nm=u(Fr);ec=s(Nm,"a"),Nm.forEach(t),tc=s(On,` and\r
    `),zr=c(On,"CODE",{});var Rm=u(zr);nc=s(Rm,"b"),Rm.forEach(t),rc=s(On,` are error handling. It's easy to see how this can get unwieldy\r
