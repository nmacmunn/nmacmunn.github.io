import{S as bs,i as vs,s as ys,k as s,a as p,y as h,J as $s,l as a,h as t,c as m,z as w,n as ws,D as r,b as o,A as c,g as b,d as v,B as y,q as n,m as f,r as l,H as cs}from"../chunks/index.5515f438.mjs";import{A as J,R as Es}from"../chunks/resources.3e3fba27.mjs";import{A as _s}from"../chunks/article.dd93a272.mjs";import{S as P}from"../chunks/snippet.eff7007e.mjs";import{S as Ss}from"../chunks/sqlite-repl.2eaf0725.mjs";const ks=`<!DOCTYPE html>
<html>
  <head>
    <style>
      body {
...
init();
`;function Ls(ce){let $,E,_,S,u,d,k,N,be,Co,Bt,K,Ft,ve,Ro,Ut,ye,Oo,Vt,$e,Qo,Jt,Ee,To,Nt,_e,Ao,Kt,Se,Ho,Gt,ke,Do,Yt,Pe,jo,Xt,Le,zo,Zt,qe,Bo,ei,C,Fo,G,Uo,ti,Ie,Vo,ii,ge,Jo,oi,R,No,Y,Ko,ri,We,Go,ni,Me,Yo,li,xe,Xo,si,O,Zo,X,er,ai,Ce,tr,fi,I,yt,ir,or,$t,rr,nr,Et,lr,pi,Re,sr,mi,Oe,ar,ui,Qe,fr,di,Te,pr,hi,Ae,mr,wi,He,ur,ci,g,_t,dr,hr,St,wr,cr,kt,br,bi,De,vr,vi,je,yr,yi,W,$r,Pt,Er,_r,Lt,Sr,kr,$i,Z,Ei,L,Pr,qt,Lr,qr,It,Ir,gr,gt,Wr,Mr,_i,ze,xr,Si,Q,Cr,Wt,Rr,Or,ki,ee,Pi,q,Qr,Mt,Tr,Ar,xt,Hr,Dr,Ct,jr,zr,Li,T,Br,Rt,Fr,Ur,qi,Be,Vr,Ii,Fe,Jr,gi,te,Wi,Ue,Nr,Mi,Ve,Kr,xi,Je,Gr,Ci,Ne,Yr,Ri,Ke,Xr,Oi,Ge,Zr,Qi,Ye,en,Ti,A,tn,Ot,on,rn,Ai,ie,Hi,Xe,nn,Di,Ze,ln,ji,et,sn,zi,H,an,Qt,fn,pn,Bi,oe,Fi,tt,mn,Ui,it,un,Vi,ot,dn,Ji,re,Ni,M,hn,ne,wn,Tt,cn,bn,Ki,rt,vn,Gi,D,yn,At,$n,En,Yi,le,Xi,nt,_n,Zi,x,Sn,Ht,kn,Pn,Dt,Ln,qn,eo,se,to,lt,In,io,st,gn,oo,at,Wn,ro,ae,no,j,Mn,jt,xn,Cn,lo,fe,so,ft,Rn,ao,z,On,zt,Qn,Tn,fo,pe,po,pt,An,mo,mt,Hn,uo,ut,Dn,ho,me,wo,dt,jn,co,ue,bo,B,zn,de,Bn,vo,F,Fn,he,Un,yo,we,$o;return _=new J({props:{href:"/posts/notry",label:"notry-ts"}}),K=new Ss({}),G=new J({props:{href:"https://swc.rs/",label:"SWC"}}),Y=new J({props:{href:"https://microsoft.github.io/monaco-editor/playground.html",label:"Monaco Playground"}}),X=new J({props:{href:"https://sqlite.org/download.html",label:"here"}}),Z=new P({props:{value:`// main.ts
import initSqlite from "./sqlite3-bundler-friendly.mjs";
...
window.MonacoEnvironment = { getWorker: () => new editorWorker() };`}}),oe=new P({props:{value:'const model = monaco.editor.createModel("", "sql");'}}),re=new P({props:{value:`function initEditor(id: string, readOnly: boolean) {
...
}`}}),ne=new J({props:{href:"https://microsoft.github.io/monaco-editor/playground.htm",label:"Monaco Playground"}}),le=new P({props:{value:`editor.onDidContentSizeChange(() => {
  const height = Math.min(600, editor.getContentHeight());
  const { width } = el.getBoundingClientRect();
  el.style.height = \`\${height}px\`;
  editor.layout({ width, height });
  ...
  run
    ...
    and thought it would be fun to do the same for SQLite.`),u=p(),d=s("p"),k=n("The good news is I got it working."),N=p(),be=s("h5"),Co=n("SQLite REPL Svelte Edition"),Bt=p(),h(K.$$.fragment),Ft=p(),ve=s("p"),Ro=n(`Unfortunately, by the time I got everything working with SvelteKit it was a\r
    ...
    for the TypeScript REPL.`),ti=p(),Ie=s("p"),Vo=n("Amazingly, SQLite (written in C) is already compiled to Wasm."),ii=p(),ge=s("h4"),Jo=n("Monaco"),oi=p(),R=s("p"),No=n(`Monaco is the code editor that powers VSCode. It provides SQL syntax\r
    ...
    rows as an array of key value-pairs.`),Li=p(),T=s("p"),Br=n("We'll revisit "),Rt=s("code"),Fr=n("run"),Ur=n(" later when it's time to integrate with Monaco."),qi=p(),Be=s("h5"),Vr=n("Clearing the database"),Ii=p(),Fe=s("p"),Jr=n(`Apart from creating a database and executing queries, the only other SQLite\r
    functionality we need is for clearing the database.`),gi=p(),h(te.$$.fragment),Wi=p(),Ue=s("p"),Nr=n("This removes all SQLite data from local storage."),Mi=p(),Ve=s("h4"),Kr=n("Monaco"),xi=p(),Je=s("p"),Gr=n("We're going to lean on Monaco to do all of the heavy lifting in terms of UI."),Ci=p(),Ne=s("h5"),Yr=n("Installation"),Ri=p(),Ke=s("p"),Xr=n("Via npm:"),Oi=p(),Ge=s("pre"),Zr=n("$ npm install monaco-editor"),Qi=p(),Ye=s("h5"),en=n("Initializing"),Ti=p(),A=s("p"),tn=n("Monaco uses the global variable "),Ot=s("code"),on=n("MonacoEnvironment"),rn=n(` to specify where\r
    ...
    be two nearly-identical editors, we'll define a function to initialize them.`),Ji=p(),h(re.$$.fragment),Ni=p(),M=s("p"),hn=n(`We won't go into all of the options here, most are self-explanatory and you\r
    ...
    and thought it would be fun to do the same for SQLite.`),i.forEach(t),u=m(e),d=a(e,"P",{});var Jn=f(d);k=l(Jn,"The good news is I got it working."),Jn.forEach(t),N=m(e),be=a(e,"H5",{});var Nn=f(be);Co=l(Nn,"SQLite REPL Svelte Edition"),Nn.forEach(t),Bt=m(e),w(K.$$.fragment,e),Ft=m(e),ve=a(e,"P",{});var Kn=f(ve);Ro=l(Kn,`Unfortunately, by the time I got everything working with SvelteKit it was a\r
    little too complex to describe in a post. So I distilled it down to a\r
    quick-and-dirty REPL that can help you get started with Monaco or SQLite in\r
    the browser.`),Kn.forEach(t),Ut=m(e),ye=a(e,"H3",{});var Gn=f(ye);Oo=l(Gn,"Some background"),Gn.forEach(t),Vt=m(e),$e=a(e,"H4",{});var Yn=f($e);Qo=l(Yn,"Databases in the browser"),Yn.forEach(t),Jt=m(e),Ee=a(e,"P",{});var Xn=f(Ee);To=l(Xn,`In 2014, I was doing a lot of work with Meteor and was blown away when I\r
    learned about Minimongo.`),Xn.forEach(t),Nt=m(e),_e=a(e,"PRE",{});var Zn=f(_e);Ao=l(Zn,"Minimongo is essentially an in-memory, non-persistent implementation of Mongo in pure JavaScript. It serves as a local cache that stores just the subset of the database that this client is working with. Queries (find) on these collections are served directly out of this cache, without talking to the server."),Zn.forEach(t),Kt=m(e),Se=a(e,"P",{});var el=f(Se);Ho=l(el,`I thought it would be great if something similar existed based on a\r
    relational database. It turns out that once upon a time there was a browser\r
    API specification called Web SQL. Unfortunately, it was deprecated back in\r
    ...
    transpiler that compiles to Wasm. It's what I used to perform in-browser transpilation\r
    for the TypeScript REPL.`),Eo.forEach(t),ti=m(e),Ie=a(e,"P",{});var nl=f(Ie);Vo=l(nl,"Amazingly, SQLite (written in C) is already compiled to Wasm."),nl.forEach(t),ii=m(e),ge=a(e,"H4",{});var ll=f(ge);Jo=l(ll,"Monaco"),ll.forEach(t),oi=m(e),R=a(e,"P",{});var _o=f(R);No=l(_o,`Monaco is the code editor that powers VSCode. It provides SQL syntax\r
    highlighting, hotkey registration, and a ton of other features that we'll\r
    only scratch the surface of. If you want to get a better idea of Monaco's\r
    ...
    rows as an array of key value-pairs.`),V.forEach(t),Li=m(e),T=a(e,"P",{});var Po=f(T);Br=l(Po,"We'll revisit "),Rt=a(Po,"CODE",{});var Ol=f(Rt);Fr=l(Ol,"run"),Ol.forEach(t),Ur=l(Po," later when it's time to integrate with Monaco."),Po.forEach(t),qi=m(e),Be=a(e,"H5",{});var Ql=f(Be);Vr=l(Ql,"Clearing the database"),Ql.forEach(t),Ii=m(e),Fe=a(e,"P",{});var Tl=f(Fe);Jr=l(Tl,`Apart from creating a database and executing queries, the only other SQLite\r
    functionality we need is for clearing the database.`),Tl.forEach(t),gi=m(e),w(te.$$.fragment,e),Wi=m(e),Ue=a(e,"P",{});var Al=f(Ue);Nr=l(Al,"This removes all SQLite data from local storage."),Al.forEach(t),Mi=m(e),Ve=a(e,"H4",{});var Hl=f(Ve);Kr=l(Hl,"Monaco"),Hl.forEach(t),xi=m(e),Je=a(e,"P",{});var Dl=f(Je);Gr=l(Dl,"We're going to lean on Monaco to do all of the heavy lifting in terms of UI."),Dl.forEach(t),Ci=m(e),Ne=a(e,"H5",{});var jl=f(Ne);Yr=l(jl,"Installation"),jl.forEach(t),Ri=m(e),Ke=a(e,"P",{});var zl=f(Ke);Xr=l(zl,"Via npm:"),zl.forEach(t),Oi=m(e),Ge=a(e,"PRE",{});var Bl=f(Ge);Zr=l(Bl,"$ npm install monaco-editor"),Bl.forEach(t),Qi=m(e),Ye=a(e,"H5",{});var Fl=f(Ye);en=l(Fl,"Initializing"),Fl.forEach(t),Ti=m(e),A=a(e,"P",{});var Lo=f(A);tn=l(Lo,"Monaco uses the global variable "),Ot=a(Lo,"CODE",{});var Ul=f(Ot);on=l(Ul,"MonacoEnvironment"),Ul.forEach(t),rn=l(Lo,` to specify where\r
    to find the worker code. This is how that looks with Vite.`),Lo.forEach(t),Ai=m(e),w(ie.$$.fragment,e),Hi=m(e),Xe=a(e,"P",{});var Vl=f(Xe);nn=l(Vl,"Without it, this warning will appear in the console:"),Vl.forEach(t),Di=m(e),Ze=a(e,"PRE",{});var Jl=f(Ze);ln=l(Jl,"Could not create web worker(s). Falling back to loading web worker code in main thread, which might cause UI freezes."),Jl.forEach(t),ji=m(e),et=a(e,"H5",{});var Nl=f(et);sn=l(Nl,"Models"),Nl.forEach(t),zi=m(e),H=a(e,"P",{});var qo=f(H);an=l(qo,"We'll create two objects of type "),Qt=a(qo,"CODE",{});var Kl=f(Qt);fn=l(Kl,"monaco.editor.ITextModel"),Kl.forEach(t),pn=l(qo,`\r
    representing text files. One will contain query history and be displayed in a\r
    ...
    be two nearly-identical editors, we'll define a function to initialize them.`),Xl.forEach(t),Ji=m(e),w(re.$$.fragment,e),Ni=m(e),M=a(e,"P",{});var bt=f(M);hn=l(bt,`We won't go into all of the options here, most are self-explanatory and you\r
