...
`;function C_(i){let r,l,m,d,b,w,v,P,y,T,U,Q,W,L,se,We,Z,$,C,O,D,Y,S,k,B,Me,pe,At,It,ee,Ii,Ni,Eo,Nt,Ri,go,Rt,Vi,$o,Vt,qi,Do,qt,Li,xo,Ye,Si,Nn,Bi,Ui,ko,Lt,Wi,Po,St,Mi,Co,Bt,Yi,Oo,Ut,Hi,To,Wt,ji,Ao,Mt,Qi,Io,Yt,Fi,No,me,Rn,zi,Ji,Vn,Ki,Gi,qn,Xi,Ro,Ht,Zi,Vo,jt,el,qo,Qt,tl,Lo,Ft,nl,So,lt,Bo,F,rl,Ln,ol,sl,Sn,il,ll,Bn,al,fl,Un,cl,ul,Uo,zt,pl,Wo,He,ml,Wn,dl,_l,Mo,at,Yo,de,hl,Mn,bl,wl,Yn,yl,vl,Ho,Jt,El,jo,ie,Ce,gl,Hn,$l,Dl,jn,xl,kl,Pl,Qn,Cl,Ol,Fn,Tl,Al,Kt,Il,zn,Nl,Qo,Gt,Rl,Fo,Xt,Vl,zo,z,ql,Jn,Ll,Sl,Kn,Bl,Ul,Gn,Wl,Ml,Xn,Yl,Hl,Jo,ft,Ko,Zt,jl,Go,je,Ql,Zn,Fl,zl,Xo,ct,Zo,ce,er,Jl,Kl,tr,Gl,Xl,nr,Zl,ea,es,ut,ts,te,rr,ta,na,or,ra,oa,sr,sa,ia,ir,la,aa,ns,pt,rs,Qe,fa,lr,ca,ua,os,le,pa,ar,Tu='{ type: "DevError" }',ma,da,fr,Au='getRecord("person", name)',_a,ha,cr,ba,wa,ss,mt,is,_e,ya,ur,Iu='{ type: "UserError", message: "<name> not found" }',va,Ea,pr,ga,$a,ls,dt,as,ue,mr,Da,xa,dr,ka,Pa,_r,Ca,Oa,fs,_t,cs,J,Ta,hr,Aa,Ia,br,Na,Ra,wr,Va,qa,yr,La,Sa,us,ht,ps,en,vr,Ba,ms,Fe,Ua,Er,Wa,Ma,ds,bt,_s,he,Ya,gr,Nu="<Y, N, Args extends unknown[]>",Ha,ja,$r,Qa,Fa,hs,be,za,Dr,Ja,Ka,xr,Ga,Xa,bs,wt,ws,j,Za,kr,ef,tf,Pr,nf,rf,Cr,of,sf,Or,lf,af,Tr,ff,cf,ys,yt,vs,H,Ar,uf,pf,Ir,mf,df,Nr,_f,hf,Rr,bf,wf,Vr,Ru="{ y: { val: boolean } }",yf,vf,qr,Vu="{ n: { val: Why, exception: unknown } }",Ef,gf,Es,K,$f,Lr,qu="MaybeAsyncDid<Y, N>",Df,xf,Sr,Lu="Did<Y, N>",kf,Pf,Br,Su="Promise<Did<Y, N>>",Cf,Of,Ur,Tf,Af,gs,tn,If,$s,nn,Nf,Ds,vt,xs,G,Rf,Wr,Vf,qf,Mr,Lf,Sf,Yr,Bf,Uf,Hr,Wf,Mf,ks,rn,Yf,Ps,ze,Hf,jr,jf,Qf,Cs,Et,Os,on,Ff,Ts,gt,As,sn,zf,Is,ln,Jf,Ns,Je,Kf,Qr,Gf,Xf,Rs,$t,Vs,we,Zf,Fr,ec,tc,zr,nc,rc,qs,Dt,Ls,an,oc,Ss,fn,sc,Bs,Ke,ic,Jr,lc,ac,Us,xt,Ws,Ge,fc,Kr,cc,uc,Ms,kt,Ys,Xe,pc,Gr,Bu="quit: Quit<Why>",mc,dc,Hs,cn,_c,js,un,hc,Qs,pn,bc,Fs,ae,wc,Xr,yc,vc,Zr,Ec,gc,eo,$c,Dc,zs,X,xc,to,kc,Pc,no,Cc,Oc,ro,Tc,Ac,oo,Ic,Nc,Js,mn,Rc,Ks,ye,Vc,so,qc,Lc,io,Sc,Bc,Gs,Pt,lo,Uc,Wc,Xs,Oe,ao,Mc,Yc,fo,Hc,jc,Zs,dn,Qc,ei,ne,Fc,co,zc,Jc,uo,Kc,Gc,po,Xc,Zc,ti,_n,eu,ni,Te,hn,tu,nu,Ze,ru,ri,Ae,bn,ou,su,et,iu,oi,Ie,wn,lu,au,tt,fu,si,Ne,yn,cu,uu,Re,pu,ii,Ve,vn,mu,du,qe,_u,li,Le,En,hu,bu,Se,wu,ai;return v=new Pe({props:{files:[{name:"person",src:m_},{name:"store",src:An,show:!1}]}}),$=new Pe({props:{files:[{name:"vote",src:d_},{name:"person",src:Td},{name:"store",src:An,show:!1}]}}),S=new Pe({props:{files:[{name:"main",src:__},{name:"vote",src:P_},{name:"person",src:Td},{name:"store",src:An,show:!1}]}}),lt=new Pe({props:{files:[{name:"main",src:h_},{name:"vote-try-catch",src:k_},{name:"person-try-catch",src:E_},{name:"error",src:Cd},{name:"report",src:gu,show:!1},{name:"store",src:An,show:!1}]}}),at=new Pe({props:{files:[{name:"main",src:b_},{name:"vote-return",src:x_},{name:"person-return",src:v_},{name:"error",src:Cd},{name:"report",src:gu,show:!1},{name:"store",src:An,show:!1}]}}),ft=new Pe({props:{files:[{name:"main",src:w_},{name:"vote-notry",src:D_},{name:"person-notry",src:y_},{name:"report",src:gu,show:!1},{name:"store",src:An,show:!1},{name:"notry-ts",src:Od,show:!1}]}}),ct=new ke({props:{value:i[1]}}),ut=new ke({props:{value:i[2]}}),pt=new ke({props:{value:i[3]}}),mt=new ke({props:{value:i[4]}}),dt=new ke({props:{value:A_}}),_t=new ke({props:{value:i[5]}}),ht=new ke({props:{value:i[6]}}),bt=new ke({props:{value:i[7]}}),wt=new ke({props:{value:i[8]}}),yt=new ke({props:{value:i[9]}}),vt=new Pe({props:{files:[{name:"main",src:Ci},{name:"ext",src:Pi,show:!1}]}}),Et=new Pe({props:{files:[{name:"main",src:Nd},{name:"safe-try-catch",src:$_},{name:"ext",src:Pi,show:!1}]}}),gt=new Eu({props:{original:Ci,modified:Nd}}),$t=new Pe({props:{files:[{name:"main",src:Id},{name:"safe-return",src:g_},{name:"ext",src:Pi,show:!1}]}}),Dt=new Eu({props:{original:Ci,modified:Id}}),xt=new Pe({props:{files:[{name:"main",src:Ad},{name:"ext",src:Pi,show:!1},{name:"notry-ts",src:Od,show:!1}]}}),kt=new Eu({props:{original:Ci,modified:Ad}}),{c(){r=f("p"),l=o(`Suppose you're asked to write a new function to determine whether a person\r
    ...
    could throw. This is one problem we want to address.`),L=_(),se=f("p"),We=o("Here's the new function."),Z=_(),A($.$$.fragment),C=_(),O=f("p"),D=o("And last but not least, the main progam."),Y=_(),A(S.$$.fragment),k=_(),B=f("p"),Me=o("Note here that the type of "),pe=f("code"),At=o("exceptionVar"),It=o(` is\r
    ...
    doesn't give the developer much to debug with.`),Io=_(),Yt=f("p"),Fi=o("So how could we improve? A few ideas:"),No=_(),me=f("ol"),Rn=f("li"),zi=o(`Log the error stack trace: this would be helpful to the developer, but\r
      ...
      still be confusing to the user.`),Gi=_(),qn=f("li"),Xi=o("Find a mechanism for differentiating error types."),Ro=_(),Ht=f("h3"),Zi=o("Approaches"),Vo=_(),jt=f("p"),el=o(`Let's explore idea #3 and compare error handling approaches using the three\r
    ...
    something different, the compiler won't tell us.`),Uo=_(),zt=f("h4"),pl=o("Return Types"),Wo=_(),He=f("p"),ml=o(`One way to lean on the type system for error handling is by using a\r
    specialized return type. We'll use a union of the successful return type and\r
    `),Wn=f("code"),dl=o("Error"),_l=o("s to keep things simple."),Mo=_(),A(at.$$.fragment),Yo=_(),de=f("p"),hl=o("This yields the same result as "),Mn=f("b"),bl=o("try-catch"),wl=o(` with the added benefit of\r
    type safety. The biggest downside is the extra check in `),Yn=f("code"),yl=o("canVote"),vl=o(`\r
    ...
    `),Gn=f("b"),Wl=o("notry-ts"),Ml=o(". Let's see how our example looks with "),Xn=f("code"),Yl=o("notry"),Hl=o("."),Jo=_(),A(ft.$$.fragment),Ko=_(),Zt=f("p"),jl=o(`This produces the same output as the two previous solutions, so how does it\r
    ...
    `),wr=f("code"),Va=o("notry"),qa=o(" and assigns the result to "),yr=f("code"),La=o("did"),Sa=o("."),us=_(),A(ht.$$.fragment),ps=_(),en=f("p"),vr=f("b"),Ba=o("How it works"),ms=_(),Fe=f("p"),Ua=o("Here is the function signature of "),Er=f("code"),Wa=o("notry"),Ma=o("."),ds=_(),A(bt.$$.fragment),_s=_(),he=f("p"),Ya=o("The generic types "),gr=f("code"),Ha=o(Nu),ja=o(` represent\r
    ...
    (either `),Or=f("code"),lf=o("Y"),af=o(" or "),Tr=f("code"),ff=o("N"),cf=o(")."),ys=_(),A(yt.$$.fragment),vs=_(),H=f("p"),Ar=f("code"),uf=o("Did"),pf=o(" is a riff on the popular "),Ir=f("code"),mf=o("Either"),df=o(` or\r
    ...
    `),Yr=f("code"),Bf=o("e"),Uf=o(`\r
    could throw so `),Hr=f("code"),Wf=o("main"),Mf=o(` catches and logs the exception. In the base\r
    case there is no way to differentiate the three possible failures.`),ks=_(),rn=f("h4"),Yf=o("try-catch"),Ps=_(),ze=f("p"),Hf=o("Let's introduce a utility "),jr=f("code"),jf=o("safe"),Qf=o(` to catch arbitrary exceptions and\r
    ...
    base case.`),Ms=_(),A(kt.$$.fragment),Ys=_(),Xe=f("p"),pc=o("Admittedly, all those "),Gr=f("code"),mc=o(Bu),dc=o(` parameters are a bit cumbersome\r
    so, like anything, you should weigh the benefits against the costs.`),Hs=_(),cn=f("h3"),_c=o("Comparison"),js=_(),un=f("p"),hc=o("Let's wrap up by looking at what we get from each approach."),Qs=_(),pn=f("h4"),bc=o("Type Safety"),Fs=_(),ae=f("p"),wc=o("None with "),Xr=f("b"),yc=o("try-catch"),vc=o(` and roughly the same degree with\r
    ...
    code and gains usefulness the more it's used.`),Xs=_(),Oe=f("p"),ao=f("b"),Mc=o("notry"),Yc=o(` has the least intuitive and most sophisticated typing. The\r
    function body's intent remains clear with error handling is mostly out of\r
    view. As with\r
    `),fo=f("b"),Hc=o("return types"),jc=o(", its usefulness is dependent on how widely it's used."),Zs=_(),dn=f("h3"),Qc=o("Conclusion"),ei=_(),ne=f("p"),Fc=o(`If you care about type safety (why else would you be here), use\r
    ...
    doesn't give the developer much to debug with.`),np.forEach(t),Io=h(e),Yt=c(e,"P",{});var rp=u(Yt);Fi=s(rp,"So how could we improve? A few ideas:"),rp.forEach(t),No=h(e),me=c(e,"OL",{});var $n=u(me);Rn=c($n,"LI",{});var op=u(Rn);zi=s(op,`Log the error stack trace: this would be helpful to the developer, but\r
    ...
    something different, the compiler won't tell us.`),ve.forEach(t),Uo=h(e),zt=c(e,"H4",{});var _p=u(zt);pl=s(_p,"Return Types"),_p.forEach(t),Wo=h(e),He=c(e,"P",{});var ui=u(He);ml=s(ui,`One way to lean on the type system for error handling is by using a\r
    specialized return type. We'll use a union of the successful return type and\r
    `),Wn=c(ui,"CODE",{});var hp=u(Wn);dl=s(hp,"Error"),hp.forEach(t),_l=s(ui,"s to keep things simple."),ui.forEach(t),Mo=h(e),I(at.$$.fragment,e),Yo=h(e),de=c(e,"P",{});var Dn=u(de);hl=s(Dn,"This yields the same result as "),Mn=c(Dn,"B",{});var bp=u(Mn);bl=s(bp,"try-catch"),bp.forEach(t),wl=s(Dn,` with the added benefit of\r
    type safety. The biggest downside is the extra check in `),Yn=c(Dn,"CODE",{});var wp=u(Yn);yl=s(wp,"canVote"),wp.forEach(t),vl=s(Dn,`\r
    ...
    throws, returning a `),cr=c(rt,"CODE",{});var Yp=u(cr);ba=s(Yp,"Person"),Yp.forEach(t),wa=s(rt," otherwise."),rt.forEach(t),ss=h(e),I(mt.$$.fragment,e),is=h(e),_e=c(e,"P",{});var kn=u(_e);ya=s(kn,`This quits with\r
    `),ur=c(kn,"CODE",{});var Hp=u(ur);va=s(Hp,Iu),Hp.forEach(t),Ea=s(kn,`\r
    ...
    `),Yr=c(De,"CODE",{});var xm=u(Yr);Bf=s(xm,"e"),xm.forEach(t),Uf=s(De,`\r
    could throw so `),Hr=c(De,"CODE",{});var km=u(Hr);Wf=s(km,"main"),km.forEach(t),Mf=s(De,` catches and logs the exception. In the base\r
    case there is no way to differentiate the three possible failures.`),De.forEach(t),ks=h(e),rn=c(e,"H4",{});var Pm=u(rn);Yf=s(Pm,"try-catch"),Pm.forEach(t),Ps=h(e),ze=c(e,"P",{});var _i=u(ze);Hf=s(_i,"Let's introduce a utility "),jr=c(_i,"CODE",{});var Cm=u(jr);jf=s(Cm,"safe"),Cm.forEach(t),Qf=s(_i,` to catch arbitrary exceptions and\r
    ...
    base case.`),wi.forEach(t),Ms=h(e),I(kt.$$.fragment,e),Ys=h(e),Xe=c(e,"P",{});var yi=u(Xe);pc=s(yi,"Admittedly, all those "),Gr=c(yi,"CODE",{});var Bm=u(Gr);mc=s(Bm,Bu),Bm.forEach(t),dc=s(yi,` parameters are a bit cumbersome\r
    so, like anything, you should weigh the benefits against the costs.`),yi.forEach(t),Hs=h(e),cn=c(e,"H3",{});var Um=u(cn);_c=s(Um,"Comparison"),Um.forEach(t),js=h(e),un=c(e,"P",{});var Wm=u(un);hc=s(Wm,"Let's wrap up by looking at what we get from each approach."),Wm.forEach(t),Qs=h(e),pn=c(e,"H4",{});var Mm=u(pn);bc=s(Mm,"Type Safety"),Mm.forEach(t),Fs=h(e),ae=c(e,"P",{});var ot=u(ae);wc=s(ot,"None with "),Xr=c(ot,"B",{});var Ym=u(Xr);yc=s(Ym,"try-catch"),Ym.forEach(t),vc=s(ot,` and roughly the same degree with\r
    `),Zr=c(ot,"B",{});var Hm=u(Zr);Ec=s(Hm,"return types"),Hm.forEach(t),gc=s(ot," and "),eo=c(ot,"B",{});var jm=u(eo);$c=s(jm,"notry-ts"),jm.forEach(t),Dc=s(ot,` including the ability to tell at a glance\r
    ...
    return value with its outcome. This solution requires the greatest amount of\r
    code and gains usefulness the more it's used.`),vu.forEach(t),Xs=h(e),Oe=c(e,"P",{});var mo=u(Oe);ao=c(mo,"B",{});var ed=u(ao);Mc=s(ed,"notry"),ed.forEach(t),Yc=s(mo,` has the least intuitive and most sophisticated typing. The\r
    function body's intent remains clear with error handling is mostly out of\r
    view. As with\r
    `),fo=c(mo,"B",{});var td=u(fo);Hc=s(td,"return types"),td.forEach(t),jc=s(mo,", its usefulness is dependent on how widely it's used."),mo.forEach(t),Zs=h(e),dn=c(e,"H3",{});var nd=u(dn);Qc=s(nd,"Conclusion"),nd.forEach(t),ei=h(e),ne=c(e,"P",{class:!0});var st=u(ne);Fc=s(st,`If you care about type safety (why else would you be here), use\r
